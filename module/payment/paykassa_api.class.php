<?php
    class PayKassaAPI {
        ...
        public function api_payment($shop, $system, $number, $amount, $currency, $comment, $paid_commission='', $tag='') {
            $fields = ["shop", "system", "number", "amount", "currency", "comment", "paid_commission", "tag"];
            return $this->query($this->url, [
                "func" => "api_payment",
            ] + compact($fields));
        }
