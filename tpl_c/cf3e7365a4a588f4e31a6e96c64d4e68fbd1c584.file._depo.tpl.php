<?php /* Smarty version Smarty-3.1.8, created on 2018-01-06 14:45:18
         compiled from "tpl/ru/depo/_depo.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19671259295a50b6cebc6739-99150636%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '19671259295a50b6cebc6739-99150636',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a50b6ceccfb73_77601290',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a50b6ceccfb73_77601290')) {function content_5a50b6ceccfb73_77601290($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('depo/_statuses.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
<?php $_tmp1=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ('edit.my.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>valueIf($_smarty_tpl->tpl_vars['from_admin']->value,'Депозит'),'fields'=>array('dID'=>array(),'duID'=>array(),'dcID'=>array(),'dState'=>array('','',0,"<b>Вывыиграли !!!</b>"),'dCTS'=>array('','Дата выиграша'),'uLogin'=>array('X','Пользователь','skip'=>!$_smarty_tpl->tpl_vars['from_admin']->value),'Bal'=>array('U','balance/bal.tpl','skip'=>!$_smarty_tpl->tpl_vars['from_admin']->value),'cName'=>array('','Плат. система'),'dZD'=>array('','Каждый день по',0,_z($_smarty_tpl->tpl_vars['el']->value['dZD'],$_smarty_tpl->tpl_vars['el']->value['dcID'],1)/4),'pName'=>array('','План',0,valueIf($_smarty_tpl->tpl_vars['from_admin']->value,"<a href=\"".$_tmp1."?id=".($_smarty_tpl->tpl_vars['el']->value['dpID'])."\" target=\"_blank\">".($_smarty_tpl->tpl_vars['el']->value['pName'])."</a>")),'dN'=>array('','Вам будет начисленно в течении ',0,($_smarty_tpl->tpl_vars['el']->value['dNPer'])." из ".($_smarty_tpl->tpl_vars['el']->value['pNPer'])),'dLTS'=>array('','Последнее начисление'),'dNTS'=>array('','Следующее начисление'),'dCompnd'=>array('','Процент реинвеста <<капитализация>>','skip'=>$_smarty_tpl->tpl_vars['chg']->value),'Compnd'=>array('','Процент реинвеста <<капитализация>>',array('compnd_wrong'=>"неверное значение [".($_smarty_tpl->tpl_vars['cmin']->value)."..".($_smarty_tpl->tpl_vars['cmax']->value)."]"),'default'=>$_smarty_tpl->tpl_vars['el']->value['dCompnd'],'skip'=>!$_smarty_tpl->tpl_vars['chg']->value),'dM'=>array('','Досрочное снятие',0,valueIf($_smarty_tpl->tpl_vars['el']->value['pClComis']>=100,'Невозможно',valueIf($_smarty_tpl->tpl_vars['el']->value['dNPer']>=$_smarty_tpl->tpl_vars['el']->value['pMPer'],"Возможно","Осталось начислений: ".(($_smarty_tpl->tpl_vars['el']->value['pMPer']-$_smarty_tpl->tpl_vars['el']->value['dNPer'])))),'skip'=>($_smarty_tpl->tpl_vars['el']->value['dState']>1)))+$_smarty_tpl->tpl_vars['modform']->value,'values'=>$_smarty_tpl->tpl_vars['el']->value,'errors'=>array('oper_disabled'=>'операция запрещена'),'btn_text'=>' ','btns'=>$_smarty_tpl->tpl_vars['modbuttons']->value), 0);?>
<?php }} ?>