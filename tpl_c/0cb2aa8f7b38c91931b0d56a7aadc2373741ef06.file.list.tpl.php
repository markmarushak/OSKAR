<?php /* Smarty version Smarty-3.1.8, created on 2017-12-23 20:36:27
         compiled from "tpl/en/list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6739999625a3e941bd82390-92039424%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0cb2aa8f7b38c91931b0d56a7aadc2373741ef06' => 
    array (
      0 => 'tpl/en/list.tpl',
      1 => 1514049977,
      2 => 'file',
  ...
  'nocache_hash' => '6739999625a3e941bd82390-92039424',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a3e941be011d3_45496512',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a3e941be011d3_45496512')) {function content_5a3e941be011d3_45496512($_smarty_tpl) {?><script type="text/javascript" src="js/lists.js"></script><?php if ($_smarty_tpl->tpl_vars['title']->value){?><h2><?php echo $_smarty_tpl->tpl_vars['title']->value;?>
...
<?php }else{ ?>list<?php }?>"><tr><?php if (is_array($_smarty_tpl->tpl_vars['btns']->value)){?><th width="20px" class="header"><input type="checkbox" id="swall" onclick="setchkbox('swall','b')" title="Select all"></th><?php }?><?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['v']->_loop = false;
...
<div>With selected: <?php echo $_smarty_tpl->tpl_vars['include_code']->value;?>
...
\'');" type="submit" class="button-red"><?php } ?></div></form><?php }?><?php }else{ ?>- No data -<br><?php }?><br><?php }} ?>