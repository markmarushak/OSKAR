<?php /* Smarty version Smarty-3.1.8, created on 2018-01-27 14:49:32
         compiled from "tpl/ru\edit.row.my.tpl" */ ?>
<?php /*%%SmartyHeaderCode:444959f748cf019771-98880381%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4dcbb35f03d818dc1fa5a8fd0c89ee2502ea01bf' => 
    array (
      0 => 'tpl/ru\\edit.row.my.tpl',
      1 => 1514062902,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '444959f748cf019771-98880381',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_59f748d0060d05_98321888',
  'variables' => 
  array (
    'v' => 0,
    'f' => 0,
...
<?php if ($_valid && !is_callable('content_59f748d0060d05_98321888')) {function content_59f748d0060d05_98321888($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['v']->value[0]=='U'){?>				<td colspan="2" align="center"><?php echo $_smarty_tpl->getSubTemplate ($_smarty_tpl->tpl_vars['v']->value[1], $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
"></div><?php }elseif($_smarty_tpl->tpl_vars['v']->value[0]=='RR'){?><?php echo $_smarty_tpl->tpl_vars['error_text']->value;?>
...
');</script><?php }elseif($_smarty_tpl->tpl_vars['v']->value[0]=='W'){?><div class="col-sm-6"><textarea<?php echo $_smarty_tpl->tpl_vars['n']->value;?>
<?php echo $_smarty_tpl->tpl_vars['hint']->value;?>
cols="60"<?php if ($_smarty_tpl->tpl_vars['v']->value['size']>0){?> rows="<?php echo $_smarty_tpl->tpl_vars['v']->value['size'];?>
"<?php }?> wrap="off" class="form-control text<?php echo $_smarty_tpl->tpl_vars['class']->value;?>
<?php echo $_smarty_tpl->tpl_vars['error_class']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['cv']->value;?>
</textarea></div><?php }elseif($_smarty_tpl->tpl_vars['v']->value[0]=='XX'){?><span class="value<?php echo $_smarty_tpl->tpl_vars['class']->value;?>
...
<?php echo $_smarty_tpl->tpl_vars['error_class']->value;?>
"><?php }?><?php }?><br><?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['l']->value;?>
<div class="col-sm-6"><?php echo $_smarty_tpl->tpl_vars['error_text']->value;?>
...
"<?php }?><?php if ($_smarty_tpl->tpl_vars['v']->value['multiple']){?> multiple="multiple"<?php }?> class="form-control select<?php echo $_smarty_tpl->tpl_vars['class']->value;?>
<?php echo $_smarty_tpl->tpl_vars['error_class']->value;?>
...
value="<?php echo $_smarty_tpl->tpl_vars['cv']->value;?>
" size="<?php if ($_smarty_tpl->tpl_vars['v']->value['size']>0){?><?php echo $_smarty_tpl->tpl_vars['v']->value['size'];?>
<?php }else{ ?>4<?php }?>"type="text" class="form-control integer<?php echo $_smarty_tpl->tpl_vars['class']->value;?>
<?php echo $_smarty_tpl->tpl_vars['error_class']->value;?>
"><?php }elseif(in_array($_smarty_tpl->tpl_vars['v']->value[0],array('F','$','%'))){?><input<?php echo $_smarty_tpl->tpl_vars['n']->value;?>
value="<?php echo $_smarty_tpl->tpl_vars['cv']->value;?>
" size="<?php if ($_smarty_tpl->tpl_vars['v']->value['size']>0){?><?php echo $_smarty_tpl->tpl_vars['v']->value['size'];?>
<?php }else{ ?>10<?php }?>"type="text" class="form-control float<?php echo $_smarty_tpl->tpl_vars['class']->value;?>
<?php echo $_smarty_tpl->tpl_vars['error_class']->value;?>
...
" size="<?php if ($_smarty_tpl->tpl_vars['v']->value['size']>0){?><?php echo $_smarty_tpl->tpl_vars['v']->value['size'];?>
<?php }else{ ?>20<?php }?>"type="password" class="form-control password<?php echo $_smarty_tpl->tpl_vars['class']->value;?>
<?php echo $_smarty_tpl->tpl_vars['error_class']->value;?>
"><?php }else{ ?><input<?php echo $_smarty_tpl->tpl_vars['n']->value;?>
<?php echo $_smarty_tpl->tpl_vars['hint']->value;?>
value="<?php echo $_smarty_tpl->tpl_vars['cv']->value;?>
" size="<?php if ($_smarty_tpl->tpl_vars['v']->value['size']>0){?><?php echo $_smarty_tpl->tpl_vars['v']->value['size'];?>
<?php }else{ ?>20<?php }?>"type="text" class="form-control string_small<?php echo $_smarty_tpl->tpl_vars['class']->value;?>
<?php echo $_smarty_tpl->tpl_vars['error_class']->value;?>
