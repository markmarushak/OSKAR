    ...
    <div class="top-wrap">
        <nav class="top-menu" id="top-menu">
                        ...
                        <ul class="horizontal-menu text-right memu-close-768">
                            ...
                            <li class="closes-menu"><a href="{_link module="refsys"}">баунти</a></li>

                            {if _uid()}
                            <li class="closes-menu"><a href="{_link module='cabinet'}"><span class="door"><img src="http://animashki.kak2z.org/pic/33/animashki-prazdniki-968.gif"></span> игровой аккаунт</a></li>
                            {if $curr1}
