	...
	{if $oper == 'CASHIN'}
		...
		{include file='edit.my.tpl'
			...
			fields=[
				...
				'Comis'=>['', 'Комиссия', 'comment'=>' <i><span id="csum"></span></i>'],
				'Sum2'=>['', 'Ваш баланс будет пополнен на сумму', 'comment'=>' <i><span id="sum2"></span></i>'],
	...
	{elseif $oper == 'CASHOUT'}
		...
		{include file='edit.my.tpl'
			...
			fields=[
				...
				'Comis'=>['', 'Комиссия', 'comment'=>' <i><span id="csum"></span></i>'],
				'Sum2'=>['', 'На Ваш счет будет выведена сумма', 'comment'=>' <i><span id="sum2"></span></i>'],
				'PIN'=>
					[
						'*',
						'Введите PIN-код!!',
	...
	{elseif $oper == 'TR'}
		...
		{include file='edit.my.tpl'
			...
			fields=[
				...
				'Sum'=>['$', 'Сумма!!', ['sum_wrong'=>'неверная сумма'], 'comment'=>' <i><span id="ccurr"></span></i>'],
				'Comis'=>['', 'Комиссия', 'comment'=>' <i><span id="csum"></span></i>'],
				'Sum2'=>['', 'Получателю будет переведена сумма', 'comment'=>' <i><span id="sum2"></span></i>'],
...
{/if}
	...
	<div class="footer-section" id="attantion-pay">
		<div class="box-pay">
			<h3>УВАЖАЕМЫЕ ИГРОКИ!</h3>
			<p>
				<p>Начисление валюты на игровой счет  через платежные системы: NixMoney,Perfect Money®,  WebMoney производится в валюте USD. После конвертируется  в рубли автоматически . Расчет конвертации валюты Игрок производит сам.</p>
				<p>BTC 0.012012    USD 68.012 Курс ЦБ.</p>
				<p>Остальные платежные системы работают во внутренней валюте RUB.</p>
				<p>А также, принять участие в беспроигрышной лотерее Вы можете  в BITCOIN, в этом случае, зачисление, игра и расчет средств производится в BITCOIN.</p></p>
		</div>
	</div>
</div>
