...
{if isset($smarty.get.done)}
		...
		<p class="info">
			Войдите в свой аккаунт <br> <a class="btn btn-info" href="{_link module='account/login'}">войти</a>
		</p>
	...
	{include file='edit.my.tpl'
		...
		[
			...
			'Agree'=>
				[
					'CC',
					"Я принимаю <a href=\"https://drive.google.com/file/d/1Q0Kq2xtLxn60GcX69PmTm9dFEJDWMo91/view?usp=sharing\" target=\"_blank\">пользовательское соглашение</a> и соглашаюсь!! с условиями предоставления услуг",
					[
